package org.sbk.doublechecklocking;
...
public class DoubleCheckTest {
    ...
    static void checkSingleton(Singleton s, int index) {
        ...
        Object s_d = s.dummy;
        if(s_a != A_VALUE) {
            System.err.println("[" + index + "] Singleton.a not initialized " + s_a);
        }
        if(s_b != B_VALUE) {
            System.err.println("[" + index + "] Singleton.b not intialized " + s_b);
        }

        if(s_c != C_VALUE) {
            System.err.println("[" + index + "] Singleton.c not intialized " + s_c);
        }
